...
static void FillRandMass (int *Arr, unsigned ArrSize, int range)
{
...
static void BubbleSort(int *Arr, unsigned ArrSize, std::string cond)
{
...
static void PrintMass(int* Array, unsigned Size)
{
